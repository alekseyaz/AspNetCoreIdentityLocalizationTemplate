    ...
    public class StsIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DefaultError()
        {
            return new IdentityError
            {
                ...
                Description = _sharedLocalizer.GetLocalizedHtmlString("An unknown failure has occurred.")
            };
        }
        ...
        public override IdentityError ConcurrencyFailure()
        {
            return new IdentityError
            {
                ...
                Description = _sharedLocalizer.GetLocalizedHtmlString("Optimistic concurrency failure, object has been modified.")
            };
        }
        ...
        public override IdentityError PasswordMismatch()
        {
            return new IdentityError
            {
                ...
                Description = _sharedLocalizer.GetLocalizedHtmlString("Incorrect password.")
            };
        }
